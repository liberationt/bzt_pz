<template>
  <div class="std-purchase-detail">
        ...
        >
          <el-form-item label="">
            <el-checkbox-group
              ...
              :disabled="isEdit == false||nodeIndex==4"
            >
    ...
    <div class="detail-module">
      ...
      <div class="form-content">
        ...
        >
          ...
          >
              <!-- v-if="(isEdit == true || nodeIndex == 1 )&& applyForm.hasAuth==true || nodeIndex<2" -->
            ...
            <el-select
              ...
              :disabled="
                applyForm.projectStatus == 3 && nodeIndex<2
              "
              v-if="nodeIndex == 1 && applyForm.hasAuth==true"
            >
              <!-- :disabled="" -->
    ...
    <div
      class="detail-module"
      v-if="status == 3 || (hasAuth == true && nodeIndex == 4)"
    >
    ...
    <div class="operation-line footer" v-if="isEdit == true">
      ...
      <template v-else-if="nodeIndex===1">
    ...
    >
      ...
      <template v-if="nodeIndex != 4">
        <template v-if="nodeIndex===1||nodeIndex===0">
          <el-button
            class="submit-btn"
            :loading="isLoading"
            @click="isEdit = true"
        ...
        >
         ...
         <el-button
          ...
          :loading="isLoading"
          @click="toExamine()"
          v-else-if="isEdit == false&&(nodeIndex==2||nodeIndex==3)"
        >
          审批
        </el-button>
      </template>
    ...
    <ProcessRejectReason
      ...
      :processInfo="{ id: applyForm.id, projectType: 14, rejectNodeName:applyForm.rejectNodeName }"
...
const nodeKey = [
  'dwfe.purchase.node01',
  'dwfe.purchase.node02',
  'dwfe.purchase.node03',
  'dwfe.purchase.node04',
  'dwfe.purchase.node05'
]
export default {
  ...
  async mounted() {
    ...
    await this.getStdPurchaseDetail();
    ...
    getStdPurchaseDetail() {
      Api.getPurchaseDetail(this.businessProId).then((res) => {
        ...
        if (code == 200) {
          ...
          this.nodeIndex = this.nodeKey.findIndex((item)=>item==data.nodeId)
       
          if (this.hasAuth == true &&  this.nodeIndex == 4) {
            this.isEdit = true;
          }
        ...
        Api.updateStdLiaisonApplyOnline(this.applyForm).then((res) => {
          ...
          if (code == 200) {
            ...
            if(this.status==5||this.status==4){
              ...
              Api.stdLiaisonReview(req).then(res=>{
                this.$message.success("标准购置已更新");
