        ...
        >
         ...
         <el-form-item label="会议纪要">
          <BztUploadFile
            ...
            :limit="limit"
            :fileSize="100"
            :disabled="taskInfo.taskState == 14007"
...
export default {
  ...
  mounted() {
    ...
    if (this.taskInfo.taskState == 14007||this.childTaskStatus==5) {
      this.getNote();
    }
    ...
    getNote() {
      ...
      Api.getRwProcessorTask(rwTaskId).then((res) => {
        ...
        if (code === 200) {
          ...
          this.limit = this.minutesList2.length + 1
        }
      });
    },
    //获取人员
      ...
      if (e === true) {
        this.$refs.uploadForm.validate((valid) => {
          if (valid) {
            ...
            if (this.taskInfo.taskState == 14007) {
              const req = {
