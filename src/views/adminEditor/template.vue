...
<script>
    ...
    import { dbServer } from '@/api/stdEditor/nodeServer';
    export default {
        ...
        methods: {
            clearForm(currPageId=undefined) {
                ...
                /* this.currPageId = currPageId || this.$editorUtils.guid();
                this.pageContent = {
                    id: undefined,
                    key: '',
            ...
            handleTabClick() {
                ...
                if (pageData) {
                    ...
                    this.currPageId = this.$editorUtils.guid();
                    this.pageContent = {
                        id: this.currPageId,
                        key: this.activeName,
                        htmlContent: `<div class="page-container"><div class="info-block" data-id="${this.currPageId}"><p>请输入模板内容</p></div></div>`,
            ...
            changeEvent(data) {
                ...
                if(data.act === 'click') {
                    ...
                    if (data.node && data.node.nodeName === 'SPAN' && this.$editorUtils.hasClass(data.node, 'tag')) {
